...
MainFrame::MainFrame(const wxString& title, const wxPoint& pos, const wxSize& size): wxFrame(nullptr, wxID_ANY, title, pos, size)
{
	...
	Bind(wxEVT_ACTIVATE_LINK, &MainFrame::onActivateLink, this);
}
...
void MainFrame::onActivateLink(wxCommandEvent& evt)
{
	linkMapper.deactivateLink();
	imageFrame->deactivateLink();
	linkMapper.activateLink(evt.GetInt());
	imageFrame->activateLink(evt.GetInt());
}
